            ...
            ?>
                <div class="row header-row">
                    ...
                    <div class="column w20">
                        ...
                        <a href="./?mod=kategori&act=hapus&id=<?= $ID; ?>" class="tombol-delete" style="font-size: 15px; padding: 2px 5px;" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                    </div>
                </div>
            <?php
            }
